...
public interface ItemsDao {
    ...
    @Query("delete from items where category=:catergory")
    Integer deleteAllByCatergory(String catergory);

    @Query("delete from items where category=:catergory and addedby=:addedBy")
    Integer deleteAllByCatergoryAndAddBy(String catergory,String addedBy);
